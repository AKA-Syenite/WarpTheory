    ...
    public static void initResearch()
    {
        ...
        researchAmulet = new ResearchItem("WARPAMULET", "ELDRITCH", new AspectList().add(Aspect.ELDRITCH, 6).add(Aspect.EXCHANGE, 3).add(Aspect.MAGIC, 3), -3, 4, 3, new ItemStack(WarpItems.itemAmulet))
                .setPages(new ResearchPage[]{
                        ...
                        new ResearchPage(new InfusionRecipe("WARPAMULET", new ItemStack(WarpItems.itemAmulet), 10, new AspectList().add(Aspect.ELDRITCH, 15).add(Aspect.EXCHANGE, 15).add(Aspect.MAGIC, 10), new ItemStack(WarpItems.itemCleanser),
                                new ItemStack[]{ItemApi.getItem("itemResource", 2), new ItemStack(Items.gold_ingot), ItemApi.getItem("itemResource", 2), new ItemStack(Items.gold_ingot)}))
